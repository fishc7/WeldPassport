...
# ── Добавлено Task 10A Block 1 (расширение CHECK — миграция 25, ADR-027 §H) ─────
AUDIT_ENTITY_QUALITY_DECISION = "QUALITY_DECISION"
# Значение, добавленное к CHECK entity_type миграцией 25 (нужно для downgrade).
QUALITY_AUDIT_ENTITY_TYPES_ADDED_IN_25: tuple[str, ...] = (
    AUDIT_ENTITY_QUALITY_DECISION,
)
...
# ── Добавлено Task 10A Block 1 (расширение CHECK — миграция 25, ADR-027 §H) ─────
# Закрытый список из пяти event_type QualityDecision (ADR-027 ACCEPTED §H).
AUDIT_EVENT_QUALITY_DECISION_CREATED = "QUALITY_DECISION_CREATED"
AUDIT_EVENT_QUALITY_DECISION_SUBMITTED = "QUALITY_DECISION_SUBMITTED"
AUDIT_EVENT_QUALITY_DECISION_RETURNED = "QUALITY_DECISION_RETURNED"
AUDIT_EVENT_QUALITY_DECISION_DECIDED = "QUALITY_DECISION_DECIDED"
AUDIT_EVENT_QUALITY_DECISION_SUPERSEDED = "QUALITY_DECISION_SUPERSEDED"
# Значения, добавленные к аудит-CHECK миграцией 25 (нужны для downgrade).
QUALITY_AUDIT_EVENT_TYPES_ADDED_IN_25: tuple[str, ...] = (
    AUDIT_EVENT_QUALITY_DECISION_CREATED,
    AUDIT_EVENT_QUALITY_DECISION_SUBMITTED,
    AUDIT_EVENT_QUALITY_DECISION_RETURNED,
    AUDIT_EVENT_QUALITY_DECISION_DECIDED,
    AUDIT_EVENT_QUALITY_DECISION_SUPERSEDED,
)
