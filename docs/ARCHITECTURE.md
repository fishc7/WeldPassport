...
> **Стык** — центральная производственная сущность; **ИД** — результат процесса, не файловый архив (ADR-006).
...
Канон границ — [[docs/project/CONSTITUTION#4. Домены и границы ответственности|Конституция §4]] ·
...
| Стык (центральный агрегат) | `production` | `joints`, жизненный цикл |
