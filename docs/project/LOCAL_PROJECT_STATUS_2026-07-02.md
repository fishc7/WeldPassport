...
| Нормы времени | `10_.../10_Нормы_времени/00_Нормы_времени.md` | Нет (отложено — ADR-003) |
...
| `norms` | Нет | Описано в документации (`base_norms`, `org_norms`); **исключено из MVP** (ADR-003) |
