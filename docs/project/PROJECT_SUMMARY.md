...
> Связанные документы: [[docs/ARCHITECTURE|Архитектура]] · [[docs/00_PROJECT_CONTEXT|Контекст проекта]] ·
> [[docs/project/DECISIONS|Решения (ADR)]] · [[docs/project/ROADMAP|Дорожная карта]] ·
> [[05_Роли_и_права/00_Ролевая_цепочка_ответственности|Ролевая цепочка]] ·
> [[03_База_данных/Модель_организаций_и_проектов|Модель организаций и проектов]] · [[00_НАВИГАЦИЯ|Навигация]].
