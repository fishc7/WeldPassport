...
TEST-DB-F2 pure runner — `implemented_unverified / pure verified / review approved`.
Следующий gate: `TEST-DB-F2-OPERATOR-PREFLIGHT`; PostgreSQL rehearsal и
operational acceptance требуют отдельного разрешения.
