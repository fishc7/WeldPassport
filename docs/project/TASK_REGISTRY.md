...
Runtime profile — `planned / implementation not started`;
TEST-DB-F2 local architecture — `accepted / implementation not started`.
Следующие gates: `RUNTIME-COMPAT-1`, затем `TEST-DB-F2-PURE-RUNNER`; operational
