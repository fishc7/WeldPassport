...
TEST-DB Foundation и Runtime profile — `machine verified / owner acceptance
pending`; TEST-DB-F2 local PostgreSQL rehearsal —
`TEST_DB_F2_REHEARSAL_VERIFIED` (run
`9e6c9986-c80d-4fee-81af-13cf9d906194`, manifest
`5da388a47e7bbac7d56a0104d6bf3b6ce61128292976596f667bb4d78d8ea0ed`).
Следующий gate: отдельная owner acceptance `TEST_DB_F2_ACCEPTED`; сохранённые
rehearsal DB не удаляются без отдельного cleanup-разрешения.
