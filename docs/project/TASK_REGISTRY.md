...
| B-04B | Repository Cut, Maintenance and Adoption | ADR-025 + ADR-030 + ADR-031 + [[docs/project/TASK_B-04B_CUT_MAINTENANCE_ADOPTION_IMPLEMENTATION_PLAN|Implementation Plan B-04B]] | `ready_for_b04b_1` | READ-ONLY Maintenance Readiness verdict `READY` к B-04B-1 принят 2026-07-29; marker transfer/adoption не выполнены и требуют отдельных gates; migration freeze active |
...
B-04B — `ready_for_b04b_1` по принятому READ-ONLY Maintenance Readiness
verdict `READY`;
