...
| B-04 | Canonical Baseline Adoption | [[docs/project/ADR-025-migration-governance-and-legacy-schema-boundary|ADR-025 (ACCEPTED)]] + [[docs/project/ADR-030-postgresql-18-b04-evidence-versioning|ADR-030 (ACCEPTED)]] + [[docs/project/TASK_B-04_CANONICAL_BASELINE_ADOPTION_SPEC|Implementation Specification B-04]] | `in_progress` | B-04A PG16 сохранён как historical evidence; B-04A-R18 принят с active PG18 evidence; B-04B не начат и blocked до нового Maintenance Readiness verdict READY; migration freeze active |
...
`done / active_authorizing`, B-04B — `planned / blocked` до нового Maintenance
