...
| B-04R | PostgreSQL 18 Restore-Roundtrip Evidence | [[docs/project/ADR-031-b04-dual-state-live-restore-evidence|ADR-031 (ACCEPTED)]] + [[docs/project/TASK_B-04R_RESTORE_ROUNDTRIP_EVIDENCE_SPEC|Specification (ACCEPTED)]] + [[docs/project/TASK_B-04R_RESTORE_ROUNDTRIP_EVIDENCE_IMPLEMENTATION_PLAN|Implementation Plan (ACCEPTED)]] | `implementation committed / evidence pending` | owner code acceptance 2026-07-29; documentation base `08bc6a09974e0272ff27938511af5d4d6ba33403`; implementation commit — commit с сообщением `feat(migrations): add B-04R restore evidence verification`; focused `58 passed`; полный `migration_contract_tests` — `378 passed, 1 skipped`; DB run и generated restore evidence отсутствуют |
...
`done / active_authorizing`, B-04R — `implementation committed / evidence pending`,
