...
| B-04R | PostgreSQL 18 Restore-Roundtrip Evidence | [[docs/project/ADR-031-b04-dual-state-live-restore-evidence|ADR-031 (ACCEPTED)]] + [[docs/project/TASK_B-04R_RESTORE_ROUNDTRIP_EVIDENCE_SPEC|Specification (ACCEPTED)]] + [[docs/project/TASK_B-04R_RESTORE_ROUNDTRIP_EVIDENCE_IMPLEMENTATION_PLAN|Implementation Plan (ACCEPTED)]] | `planned / implementation preflight` | architecture, Spec и implementation plan приняты 2026-07-29; live `e9e5affd...`, stable restore `3a9e682c...`; exact diff 133 CHECK + 2 predicates; code blocked до owner-authorized documentation commit/base SHA; DB evidence отдельно blocked |
...
`done / active_authorizing`, B-04R — `planned / implementation preflight`,
