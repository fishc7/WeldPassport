...
| Task 9D-4A-5 | `DefectDisposition` — ADR-024 Alignment | [[docs/project/ADR-024-defect-disposition-lifecycle-authority-model|ADR-024 (ACCEPTED)]] + [[docs/project/TASK_9D-4A-5_DEFECT_DISPOSITION_ADR024_ALIGNMENT_SPEC|Implementation Specification 9D-4A-5]] | `planned / blocked_by_authentication` | B-03, B-04, TEST-DB-FOUNDATION и Runtime Compatibility Profile завершены; spec `DRAFT — awaiting independent review`; execution 9D-4A-5A ожидает отдельный `AUTHENTICATION_BOUNDARY_ACCEPTED`; implementation/commit pending |
...
| AUTHENTICATION-BOUNDARY | Server-authenticated actor context | [[docs/project/ADR-034-authentication-boundary|ADR-034 (ACCEPTED)]] + [[docs/superpowers/specs/2026-07-30-authentication-boundary-design|Architecture Design (ACCEPTED)]] + [[docs/superpowers/plans/2026-07-30-authentication-boundary|Implementation Plan (ACCEPTED)]] + [[docs/project/TASK_AUTHENTICATION_BOUNDARY_CLAUDE_CODE_PROMPT|Cursor / Claude Code Prompt (ACCEPTED)]] | `IMPLEMENTED_UNVERIFIED / PURE VERIFIED` | commits `ee3d835` → `6560016`; focused identity gate `38 passed`; полный `migration_contract_tests` `863 passed, 3 skipped`; PostgreSQL/Alembic/application suite не запускались; `AUTHENTICATION_BOUNDARY_ACCEPTED` не присвоен; следующий gate — отдельно авторизованная disposable PostgreSQL 18.3 acceptance |
| RUNTIME-LEGACY-COMPATIBILITY-PROFILE | Canonical/Legacy Runtime Composition | [[docs/project/ADR-025-migration-governance-and-legacy-schema-boundary|ADR-025 (ACCEPTED)]] + [[docs/project/ADR-032-test-db-foundation-and-runtime-bootstrap-boundary|ADR-032 (ACCEPTED)]] + [[docs/project/TASK_RUNTIME_LEGACY_COMPATIBILITY_PROFILE_SPEC|Implementation Specification (ACCEPTED)]] + [[docs/project/TASK_RUNTIME_LEGACY_COMPATIBILITY_PROFILE_IMPLEMENTATION_PLAN|Implementation Plan (ACCEPTED)]] + [[docs/project/TASK_RUNTIME_LEGACY_COMPATIBILITY_PROFILE_CLAUDE_CODE_PROMPT|Cursor / Claude Code Prompt (ACCEPTED)]] | `done / TEST_DB_F2_ACCEPTED` | RUNTIME-COMPAT-1 commits `0b3cbdd` → `5df1278`; PostgreSQL 18.3 run `9e6c9986-c80d-4fee-81af-13cf9d906194`; manifest `5da388a47e7bbac7d56a0104d6bf3b6ce61128292976596f667bb4d78d8ea0ed`; owner acceptance `2026-07-30T07:17:11.636887Z`, SHA `224974992524dc53cd8bd06b6a602ab83e76e9e6d97fb4f6d54ff687f2cab009` |
| TEST-DB-FOUNDATION | Isolated PostgreSQL Test Database Foundation | [[docs/project/ADR-025-migration-governance-and-legacy-schema-boundary|ADR-025 (ACCEPTED)]] + [[docs/project/ADR-029-test-db-safety-interlock|ADR-029 (ACCEPTED)]] + [[docs/project/ADR-032-test-db-foundation-and-runtime-bootstrap-boundary|ADR-032 (ACCEPTED)]] + [[docs/project/ADR-033-test-db-f2-local-rehearsal|ADR-033 (ACCEPTED)]] + [[docs/project/TASK_TEST_DB_FOUNDATION_SPEC|Implementation Specification (ACCEPTED)]] + [[docs/project/TASK_TEST_DB_FOUNDATION_IMPLEMENTATION_PLAN|Implementation Plan]] + [[docs/project/TASK_TEST_DB_FOUNDATION_CLAUDE_CODE_PROMPT|Cursor / Claude Code Prompt]] + [[docs/project/TASK_TEST_DB_F2_PURE_RUNNER_SPEC|F2 Pure Runner Specification (IMPLEMENTED)]] + [[docs/project/TASK_TEST_DB_F2_PURE_RUNNER_IMPLEMENTATION_PLAN|F2 Pure Runner Plan (ACCEPTED)]] + [[docs/project/TASK_TEST_DB_F2_PURE_RUNNER_CLAUDE_CODE_PROMPT|F2 Pure Runner Prompt (ACCEPTED)]] + [[docs/project/TASK_TEST_DB_F2_OPERATOR_PREFLIGHT_SPEC|F2 Operator Preflight Specification (IMPLEMENTED)]] + [[docs/project/TASK_TEST_DB_F2_OPERATOR_PREFLIGHT_IMPLEMENTATION_PLAN|F2 Operator Preflight Plan (ACCEPTED)]] + [[docs/project/TASK_TEST_DB_F2_OPERATOR_PREFLIGHT_CLAUDE_CODE_PROMPT|F2 Operator Preflight Prompt (ACCEPTED)]] | `done / TEST_DB_F2_ACCEPTED` | TEST-DB-F1 `20c7ea7`; remediation `53441c7` → `8148794`; final pure `825 passed, 3 skipped`; PostgreSQL 18.3 run `9e6c9986-c80d-4fee-81af-13cf9d906194`; manifest `5da388a47e7bbac7d56a0104d6bf3b6ce61128292976596f667bb4d78d8ea0ed`; owner acceptance SHA `224974992524dc53cd8bd06b6a602ab83e76e9e6d97fb4f6d54ff687f2cab009` |
...
TEST-DB Foundation и Runtime profile — `done / TEST_DB_F2_ACCEPTED`;
TEST-DB-F2 local PostgreSQL rehearsal — `TEST_DB_F2_REHEARSAL_VERIFIED` (run
`9e6c9986-c80d-4fee-81af-13cf9d906194`, manifest
`5da388a47e7bbac7d56a0104d6bf3b6ce61128292976596f667bb4d78d8ea0ed`);
owner acceptance SHA
`224974992524dc53cd8bd06b6a602ab83e76e9e6d97fb4f6d54ff687f2cab009`.
Следующий обязательный prerequisite перед Task 9D-4A-5A —
`AUTHENTICATION_BOUNDARY_ACCEPTED`. ADR-034 и Architecture Design приняты;
implementation/evidence ещё не выполнены. Сохранённые rehearsal DB не удаляются
без отдельного cleanup-разрешения.
